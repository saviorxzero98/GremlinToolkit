...
namespace GQL.JanusGraphClients
{
    public class JanusGraphGremlinClient : IGremlinQueryClient
    {
        public JanusGraphDatabaseConfig Config { get; set; }
        public GremlinClient Client { get; protected set; }
        protected CancellationTokenRegistration CancellationRegistration { get; set; }

        public JanusGraphGremlinClient(JanusGraphDatabaseConfig config, CancellationToken cancellationToken = default(CancellationToken))
        {
            Config = config;
        ...
        public JanusGraphGremlinClient(JanusGraphDatabaseConfig config, GremlinQueryClientOptions options,
